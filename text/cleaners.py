...
def global_phonemizer():
    if not hasattr(global_phonemizer, "singleton"):
        global_phonemizer.singleton = phonemizer.backend.EspeakBackend(
            language="en-us",
    ...
    return global_phonemizer.singleton
